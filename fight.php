<?php 
 ...
 //    $f3->route('GET /fight/@cardnumber','fight');
	...
	// function fight($f3) {
		...
		if (!$f3->exists('GET.cardnumber') || (
			$f3->get('GET.cardnumber') != 3 &&
			$f3->get('GET.cardnumber') != 7 &&
			$f3->get('GET.cardnumber') != 11) ){
			$f3->set('GET.cardnumber',7);
		}

		shuffle($cartodata);
		$cartodata = array_slice ($cartodata, 0, $f3->get('GET.cardnumber'));
